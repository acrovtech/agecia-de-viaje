    ...
    <section className="relative h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-20 text-center text-white px-4 flex flex-col items-center justify-center h-full w-full max-w-5xl mx-auto pt-20 lg:pt-0">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 tracking-tight drop-shadow-lg leading-tight px-8 lg:px-0">
          Explora Perú de la forma más auténtica
        </h1>
        ...
        <div className="flex lg:hidden gap-4 mt-8">
          <a href="#" aria-label="Facebook" className="w-11 h-11 rounded-full bg-white/20 hover:bg-white/40 flex items-center justify-center backdrop-blur-sm transition-colors text-white">
          ...
          <a href="#" aria-label="Instagram" className="w-11 h-11 rounded-full bg-white/20 hover:bg-white/40 flex items-center justify-center backdrop-blur-sm transition-colors text-white">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
          </a>
          <a href="#" aria-label="TripAdvisor" className="w-11 h-11 rounded-full bg-white/20 hover:bg-white/40 flex items-center justify-center backdrop-blur-sm transition-colors text-white">
