    ...
    <div className="grid grid-cols-3 gap-12 w-full mt-4 px-12 pb-4">
      ...
      <div>
        <div className="w-full h-40 bg-gray-600 rounded-xl mb-6 relative overflow-hidden shadow-lg">
          <Image 
            src="https://pub-f6310552a1b646efb46a653a7f05720c.r2.dev/assets/paquetes/ai-paquete-lima-cusco.webp" 
      ...
      <div>
        <div className="w-full h-40 bg-gray-600 rounded-xl mb-6 relative overflow-hidden shadow-lg">
          <Image 
            src="https://pub-f6310552a1b646efb46a653a7f05720c.r2.dev/assets/paquetes/ai-paquete-lima-arequipa.webp" 
      ...
      <div>
        <div className="w-full h-40 bg-gray-600 rounded-xl mb-6 relative overflow-hidden shadow-lg">
          <Image 
            src="https://pub-f6310552a1b646efb46a653a7f05720c.r2.dev/assets/paquetes/ai-paquete-lima-ica.webp" 
