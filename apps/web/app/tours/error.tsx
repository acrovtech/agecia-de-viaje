...
export default function ToursError({
  ...
  useEffect(() => {
    console.error('Error en sección de tours:', error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F9FAFA]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center min-h-[50vh] px-4 py-16 text-center">
        ...
        <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">No pudimos cargar los tours</h2>
        <p className="text-sm text-gray-600 max-w-md mb-6">
          Ocurrió un problema temporal al consultar nuestro catálogo. Por favor intenta recargar o regresa a la página principal.
        </p>
