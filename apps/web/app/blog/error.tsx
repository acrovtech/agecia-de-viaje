...
export default function BlogError({
  ...
  useEffect(() => {
    console.error('Error en sección de blog:', error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F9FAFA]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center min-h-[50vh] px-4 py-16 text-center">
        ...
        <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">No pudimos cargar los artículos</h2>
        <p className="text-sm text-gray-600 max-w-md mb-6">
          Ocurrió un error al consultar las publicaciones del blog. Puedes reintentar la carga o navegar a otras secciones.
        </p>
