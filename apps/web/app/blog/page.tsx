      ...
      <main className="flex-1">
        ...
        <div className="relative h-[80dvh] min-h-[500px] w-full bg-gray-900 flex items-center justify-center">
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-[url('https://pub-f6310552a1b646efb46a653a7f05720c.r2.dev/assets/blogs-hero-inca-bound.webp')] bg-cover bg-center opacity-50" />
